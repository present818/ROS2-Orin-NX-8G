...
def launch_setup(context):
    # compiled创造出来是为了干啥的，environ是干啥的，‘need_compile’莫名其妙蹦出来，不知道有啥用
    compiled = os.environ['need_compile']
    # 这些什么enable_save use_sim_time map_frame等等都是从何而来，肯定是在别的文件里定义好的吧？
    ...
    slam_params = RewrittenYaml(
        ...
        # 不是这use_sim_time在slam.yaml里面也没有啊，我没找到
        param_rewrites={
