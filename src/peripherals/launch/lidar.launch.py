...
def generate_launch_description():
    ...
    lidar_launch_path = os.path.join(peripherals_package_path, 'launch/include/ld19.launch.py')
    ...
    laser_filters_config = os.path.join(peripherals_package_path, 'config/lidar_filters_config.yaml')
