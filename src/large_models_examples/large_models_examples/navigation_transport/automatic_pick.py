...
class AutomaticPickNode(Node):
    ...
    def __init__(self, name):
        ...
        if self.debug == 'pick':
            # self.agc.run_action('navigation_pick_debug')
            ...
            # self.agc.run_action('navigation_place_debug')
    ...
    def action_thread(self):
        while True:
            if self.pick:
                ...
                self.controller.traveling(gait=-2, time=1, steps=0)
                time.sleep(0.5)
                set_servo_position(self.joints_pub, 1.5, ((19, 500), (20, 220), (21, 290), (22, 280), (23, 500), (24, 700)))
                time.sleep(2)
                set_servo_position(self.joints_pub, 0.5, ((19, 500), (20, 220), (21, 290), (22, 280), (23, 500), (24, 700)))
                time.sleep(0.5)
                set_servo_position(self.joints_pub, 0.5, ((19, 500), (20, 220), (21, 290), (22, 280), (23, 500), (24, 450)))
                time.sleep(0.5)
                set_servo_position(self.joints_pub, 0.5, ((19, 500), (20, 220), (21, 290), (22, 280), (23, 500), (24, 450)))
                time.sleep(0.3)
                set_servo_position(self.joints_pub, 1.5, ((19, 500), (20, 700), (21, 155), (22, 70), (23, 500), (24, 450)))
                time.sleep(1.5)
                set_servo_position(self.joints_pub, 0.3, ((19, 500), (20, 700), (21, 155), (22, 70), (23, 500), (24, 450)))
                self.pick = False
        ...
        if not self.pick or self.debug == 'pick':
            ...
            if self.debug == 'pick':
                ...
                if self.status != "align":
                    ...
                    self.get_logger().info(f'tmp{tmp}')
