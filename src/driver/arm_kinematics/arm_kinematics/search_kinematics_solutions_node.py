...
from arm_kinematics.inverse_kinematics import get_ik, set_link, get_link, set_joint_range, get_joint_range

from servo_controller_msgs.msg import ServoStateList
from arm_kinematics_msgs.msg import JointsRange, Link
from arm_kinematics_msgs.srv import SetRobotPose, SetJointValue, GetRobotPose, SetLink, GetLink, SetJointRange, GetJointRange
...
def main():
    node = SearchKinematicsSolutionsNode('arm_kinematics')
    rclpy.spin(node)
    node.destroy_node()
    rclpy.shutdown()
