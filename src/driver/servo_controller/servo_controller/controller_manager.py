...
class ControllerManager(Node):
    def __init__(self, name):
        ...
        self.servo_manager.connect()  # 检查是否有给定的舵机已连接 (Check if the specified servo is connected)
        ...
        # 确保ros_robot_controller已完成初始化 (Ensure that ros_robot_controller has completed initialization)
