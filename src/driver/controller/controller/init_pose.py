...
class InitPose(Node):
    def __init__(self, name):
        ...
        if self.type == 'action':
            ...
            acg = action_group_controller.ActionGroupController(self.servo_controller_pub, '/home/ubuntu/software/actionset_editor/ActionGroups')
            ...
            data = []   
            for i in ['id19', 'id20', 'id21', 'id22', 'id23', 'id24']:
                servo = ServoPosition()
                servo.id = int(i[2:]) 
