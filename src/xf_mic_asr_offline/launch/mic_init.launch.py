...
def launch_setup(context):
    ...
    if mic_type == 'xf':
        appid = LaunchConfiguration('appid', default="'5aed8165'")
        enable_setting = LaunchConfiguration('enable_setting', default='false')
        confidence = LaunchConfiguration('confidence', default='20')  # 语音识别结果自信度阈值，取值：0-100(voice recognition result confidence ranging from 0 to 100)
