...
def generate_launch_description():
    ...
    if compiled == 'True':
        jetspider_description_package_path = get_package_share_directory('jetspider_description')
    else:
        jetspider_description_package_path = '/home/ubuntu/ros2_ws/src/simulations/jetspider_description'
    urdf_path = os.path.join(jetspider_description_package_path, 'urdf/jetspider.xacro')
    rviz_config_file = os.path.join(jetspider_description_package_path, 'rviz/view.rviz')
    ...
    rviz_launch = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(jetspider_description_package_path, 'launch', 'rviz.launch.py')),
