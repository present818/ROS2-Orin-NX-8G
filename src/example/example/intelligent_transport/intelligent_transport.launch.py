...
def launch_setup(context):
    ...
    map_name = LaunchConfiguration('map', default='map_03').perform(context)
    debug = LaunchConfiguration('debug', default='false')
    broadcast = LaunchConfiguration('broadcast', default='false')
    place_without_color = LaunchConfiguration('place_without_color', default='false ')
    ...
    intelligent_pick_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(example_package_path, 'example/intelligent_transport/intelligent_pick.launch.py')),
        launch_arguments={
            'broadcast': broadcast,
            'debug': debug,
    ...
    intelligent_transport_node = Node(
        package='example',
        executable='intelligent_transport',
        output='screen',
