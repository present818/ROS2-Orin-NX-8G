...
def launch_setup(context):
    ...
    yolov11_node = Node(
        ...
        output='screen',
        parameters=[{'classes': ['left', 'right', 'red', 'green', 'yellow','one','two','three','four','duck','crosswalk']},
                    {'use_depth': True, 'model_name': 'best_urban_traffic.pt','conf': 0.75}]
    )

    urban_traffic_node = Node(
        package='example',
        executable='urban_traffic',
        output='screen',
